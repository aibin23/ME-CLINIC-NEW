    ...
    <body>
        <section class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container">
               ...
               <a href="#" class="navbar-brand">Malabon E-Clinic</a>
               <!-- MENU LINKS -->
        ...
        <div class="table-responsive  center-block" style="width: 1200px; width: 1300px">  
            <h3 align="center">CLINIC ADMIN PORTAL</h3><br />
            <h4 align="center">PENDING SCHEDULES</h4><br />
            <span id="result"></span>
            <div id="live_data"></div>
            
            <h4 align="center">APPROVED</h4><br />
            <span id="result"></span>
...
$(document).ready(function(){
    ...
    function fetch_data()  
    {   var clinicname = localStorage.getItem("username");
        $.ajax({  
            url:"select.php",  
            method:"POST",
