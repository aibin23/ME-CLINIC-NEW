<?php  
 ...
 $output = '';  
 $sql = "SELECT * FROM tblschedule ORDER BY pdate ASC, ptime ASC";  
          ...
          $rownum++;
           $output .= '  
                <tr>  
                     ...
                     <td><button type="button" name="delete_btn" data-id8="'.$row["psid"].'" class="btn btn-xs btn-danger btn_delete" style="padding: 5px">DELETE</button></td>  
                </tr>  
           ';  
      }  
      $output .= '  
